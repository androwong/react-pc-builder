                     ...
                     (
                        <Fragment>
                                       ...
                                       <div className="d-flex iron-cart-post">
                                          ...
                                          <div className=" cart-content-wrap d-flex justify-content-start align-items-center">
                                             ...
                                             <div className="cart-edit-action d-flex justify-content-end align-items-center">
                                                ...
                                                <Button component={Link} to="/cart/current" className="icon-btn button" onClick={this.handleClose} >
                           ...
                           <div className=" py-15 px-10">
                              <Button onClick={this.handleClose} component={Link} to="/cart/current" className="button btn-active w-100">
                                 checkout
                              </Button>
                           </div>
                        </Fragment>
