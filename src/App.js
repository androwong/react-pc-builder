                  ...
                  {this.getUrl(location.pathname) ?
                     ...
                     <div className="app-container">
                        ...
                        <Switch>
                           ...
                           <Route path="/shop/:type/:component" component={AsyncShopComponent} />
                           <Route path="/shop/:type" component={AsyncBuildComponent} />
                           <Route path="/cart/:id" component={AsyncCartComponent} />
